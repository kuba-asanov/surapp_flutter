...
class _SendQuestioniewState extends State<SendQuestioniew> {
  ...
  Widget build(BuildContext context) {
    return UiCommandsConsumer<AskQuestionBloc, AskQuestionUiCommands>(
      bloc: widget.bloc,
      listener: (context, command) {
        switch (command) {
          case ShowToastUiCommand():
            switch (command.type) {
              case ToastType.created:
                SmartDialog.showToast(
                  "Сурооңуз ийгиликтүү түзүлдү!",
                  maskColor: Colors.green,
                );
              case ToastType.ustazRequired:
                SmartDialog.showToast("Бир устазды сөзсүз тандаш керек");
              case ToastType.categoryRequired:
                SmartDialog.showToast("Бир категорияны сөзсүз тандаш керек");
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      // setState(() {});
                                      widget.bloc.add(AddRemoveCategoryEvent(
                                          item[index].id));
